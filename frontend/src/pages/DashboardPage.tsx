...
import type { Admin, CustomerPage, DashboardStats, SortField, SortOrder } from '../types'
...
export function DashboardPage({ admin, token, onLogout }: Props) {
  ...
  }, [token, page, search, status, sortBy, sortOrder])
    ...
    <main className="app-shell">
      ...
      <section className="dashboard-content">
        ...
        <section className="customer-card">
          ...
          <CustomerTable customers={customers?.items ?? []} loading={loading} sortBy={sortBy} sortOrder={sortOrder} onSort={changeSort} />
